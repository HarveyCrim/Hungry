...
const PhoneNav = () => {
    ...
    return (
        <div ref = {slideRef} className = {`md:hidden ${!drawer ? "hidden" : "flex"} z-30 fixed animate-in slide-in-from-right top-[0px] z-10 right-[0px] flex-col min-h-screen bg-orange-500/90 w-[80%] border-2 border-orange-500`}>
